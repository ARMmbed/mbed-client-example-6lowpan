...
4. Set the `IPv6` address for mbed DS in `source/mbedclient.cpp` if you have not done it yet. The instructions are in the [Client side](#client-side) section of this document. 
...
* Click **mbed-client-6lowpan-endpoint**. It will bring you to a panel where you will see panes called **Device** and **Test**:
...
In case **mbed-client-6lowpan-endpoint** is not visible in the Connected Home application or if the 
